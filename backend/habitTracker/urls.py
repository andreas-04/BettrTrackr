...
from .views import TaskViewSet, HabitTrackerViewSet, GoalViewSet, SendMessage, MentorConfigViewSet
...
router.register(r'mentor_config', MentorConfigViewSet)
...
urlpatterns = [
    ...
    path('send_message/<int:habitId>/', SendMessage.as_view(), name="messaging"),
]